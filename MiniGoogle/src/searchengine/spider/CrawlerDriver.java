	...
	public static void main (String[] args) {
		try {
			...
			if (args.length >= 2) {
				...
				//System.out.println("index Mode At Crawler Page--->"+indexMode);
					...
					|| indexMode.equals("bst") || indexMode.equals("avl")) 
				{
					...
					//Indexer indexer=new Indexer(indexMode);
					//web=new BreadthFirstSpider(u,indexer);
				}
			...
			// Crawl the web site
			//System.out.println("Calling Indexer page");
